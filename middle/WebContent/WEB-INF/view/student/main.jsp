...
<div class="product-image-thumb active"><img src="<%= request.getContextPath() %>/img/정문.jpg" alt="Product Image" onclick="changeImage(this)"></div>
<div class="product-image-thumb"><img src="<%= request.getContextPath() %>/img/행정관.jpg" alt="Product Image" onclick="changeImage(this)"></div>
<div class="product-image-thumb"><img src="<%= request.getContextPath() %>/img/풍산마당.jpg" onclick="changeImage(this)"></div>
<div class="product-image-thumb"><img src="<%= request.getContextPath() %>/img/미술관.jpg" onclick="changeImage(this)"></div>
<div class="product-image-thumb"><img src="<%= request.getContextPath() %>/img/자하연.jpg" onclick="changeImage(this)"></div>
</div>
</div>
<div class="col-12 col-sm-6">
