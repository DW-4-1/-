				...
				<div class="card-body">
					<div class="row">
						<div class="col-12 col-sm-12">
								<h4>
									<i class="fas fa-globe" class="m-0">
									</i> 내 정보 확인 <small class="float-right">Date: 2/10/2014</small> <br> <br>
								</h4>
							</div>
							...
							<div class="col-6" id="text-center">
								<div class="table-responsive">
									...
									<input class="btn btn-primary" type="button"
										id="stuInfoUpdateBtn" value="내 정보 수정하기"> <input
										class="btn btn-primary" type="button" id="passUpdateBtn"
										value="비밀번호 변경하기">
						...
						<div class="col-12" id="text-center">
							...
							<p class="text-muted well well-sm shadow-none"
								...
								<br>weebly ning heekya handango imeem plugg dopplr jibjab,
								movity jajah plickers sifteo edmodo ifttt zimbra.
							</p>
						</div>
						</div>
						</div>
